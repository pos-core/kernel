...
| media uses consumer profile order for equal specificity | When equally specific media variants match, the variant containing the earliest differing attribute in the active consumer profile wins. | Passed | 0 ms |
