...
It records the prompts and choices that apply, resolved labels, quantities, explicit-or-default selection sources, validated choice-input values, effects, and nested configurations. It can calculate modifier pricing or dehydrate back into effective selections.
